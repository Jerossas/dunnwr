...
1. Wide grip, four seconds negative 8 reps. Cuando menciona negatives, significa que, cuando se lleve el peso al pecho, al subir, por lo menos durar 4 segundos. 
    ![Lat Pulldown wide grip](wide-grip.png "Lat pulldown wide grip")

2. Medium grip, AMRAP (As Many Repetitions As Possible), es decir, al fallo :v
    ![Lat pulldown medium grip](medium-grip.jpeg "Lat pulldown medium grip")

3. Underhand grip, AMRAP
    ![Lat pulldown underhand medium grip](underhand.jpeg "Lat pulldown underhand medium grip")
...
![Isolateral row with machine](isolateral-row.png "Chris haciendo Isolateral row con máquina")
...
1. Straight-arm rope pulldown
    ![Straight-arm rope pulldown](arm-rope.jpeg "Ejemplo de Stright-arm rope pulldown")
2. Seated row
    ![Seated row](seated-row.jpeg "Este es el remo normal sentado con máquina")
3. Chest-supported DB row
    ![Chest-supported DB row](chest-row.jpeg "Acostadito y con mancuernas :v")
